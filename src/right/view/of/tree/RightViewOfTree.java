...
public class RightViewOfTree {
    public static void main(String[] args) throws IOException {
        ...
        while (testCaseCount-- > 0) {
            ...
            rightViewOfTree(arrInput, rootNode, writer);
            writer.write("\n");
            writer.flush();
        }
        //writer.flush();
    ...
    private static void rightViewOfTree(int[] arrInput, Node rootNode, BufferedWriter writer) throws IOException {
    ...
    private static void putDepth(Node rootNode, Map<Integer, Integer> nodeDepthMap, int depth) {
        ...
        //This will create right view of the tree as we are putting right node data only
