...
public class ForestAlter {
    ...
    private static boolean isTree(ArrayList<ArrayList<Integer>> graph, int S, boolean[] visited, int parent) {
        visited[S] = true;
